...
export const MusicLogo: React.FC<IconSvgProps> = ({
                                                      width,
                                                      size = 100,
                                                      height,
                                                      ...props
...
export const SwitchLogo: React.FC<IconSvgProps> = ({
                                                       width,
                                                       size = 100,
                                                       height,
                                                       ...props
...
export const PlayStationLogo: React.FC<IconSvgProps> = ({
                                                            width,
                                                            size = 100,
                                                            height,
                                                            ...props
...
export const TypeScriptLogo: React.FC<IconSvgProps> = ({
    ...
    <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        height={size || height}
        width={size || width} viewBox="0 0 24 24"
    >
        <path fill="currentColor"
...
export const MysqlLogo: React.FC<IconSvgProps> = ({
                                                      width,
                                                      size = 100,
                                                      height,
                                                      ...props
