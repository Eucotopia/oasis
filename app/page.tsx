            ...
            {[...new Array(3).fill(1)].map((_, index) => {
                return (
                    <div
                        ...
                        className="bg-content1 p-8 md:p-14 rounded-3xl mb-4"
                    >
...
const data = [
    ...
    {
        category: "限时优惠",
        title: "入手 Mac 或 iPad 上高校更超值",
        description: "Make Something Wonderful.",
        src: "/Store Card 40 BTS Offer GEO CN.jpeg",
        content: <Apple/>,
    },
    {
        category: "MUSIC",
...
export default function Home() {
    ...
    const cards = data.map((card, index) => (
        <AnimatedCard key={card.src} card={card} index={index} layout={true}/>
    ));
